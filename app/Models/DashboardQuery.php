    ...
    public function diagnosaBulanan()
    {
      ...
      from(
          ...
          from (
              ...
              where a.diagnosa is not null and r.tgl_rekam LIKE "%2023-11%"
              union all
              select diagnosa
              from rekam_gigi
              where created_at LIKE "%2023-11%"
          ) sc
          group by diagnosa
      )aa
    ...
    public function diagnosaYearly()
    {
        ...
        from(
            ...
            from (
                ...
                from rekam_diagnosa a
                LEFT JOIN rekam r ON r.id = a.rekam_id
                where a.diagnosa is not null and r.tgl_rekam LIKE "%2023-%"
                union all
                select diagnosa
                from rekam_gigi
