...
<head>
    ...
    <title>Puskesmas Mergosono</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('images/logo_puskesmas.png')}}">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										{{-- <a href="#">
                                            <h2 class="text-white">Puskesmas Mergosono</h2>
                                        </a> --}}
                                        <img class="logo-abbr" style="max-width: 50px;" src="{{asset('images/logo_puskesmas.png')}}" alt="">
                                    ...
                                    <form action="{{Route('login.auth')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="email" value="" required name="email">
                                        </div>
                                        <div class="form-group">
